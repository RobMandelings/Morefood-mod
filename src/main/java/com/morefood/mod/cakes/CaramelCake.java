package com.morefood.mod.cakes;
...
public class CaramelCake extends Block
{
	@SideOnly(Side.CLIENT)
    private IIcon blockIcona;
    @SideOnly(Side.CLIENT)
    private IIcon blockIconb;
    @SideOnly(Side.CLIENT)
    private IIcon blockIconc;
    ...
    {
        return p_149691_1_ == 1 ? this.blockIcona : (p_149691_1_ == 0 ? this.blockIconb : (p_149691_2_ > 0 && p_149691_1_ == 4 ? this.blockIconc : this.blockIcon));
    }

    @SideOnly(Side.CLIENT)
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
    	this.blockIcon = p_149651_1_.registerIcon(Morefood.modid + ":" + this.getUnlocalizedName().substring(5) + "_side");
    	this.blockIcona = p_149651_1_.registerIcon(Morefood.modid + ":" + this.getUnlocalizedName().substring(5) + "_top");
        this.blockIconb = p_149651_1_.registerIcon(Morefood.modid + ":" + this.getUnlocalizedName().substring(5) + "_bottom");
        this.blockIconc = p_149651_1_.registerIcon(Morefood.modid + ":" + this.getUnlocalizedName().substring(5) + "_inner");
    }
    ...
    private void func_150036_b(World p_150036_1_, int p_150036_2_, int p_150036_3_, int p_150036_4_, EntityPlayer p_150036_5_)
    {
        ...
        {
            p_150036_5_.getFoodStats().addStats(3, 0.1F);
    ...
    {
        return Morefood.itemCaramelCake;
    }
}