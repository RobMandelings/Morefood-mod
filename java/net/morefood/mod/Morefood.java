...
import net.morefood.mod.cakes.AppleCake;
import net.morefood.mod.cakes.BlueberryCake;
import net.morefood.mod.cakes.CaramelCake;
import net.morefood.mod.cakes.ChocolateCake;
import net.morefood.mod.cakes.StrawberryCake;
import net.morefood.mod.crops.AspCrop;
import net.morefood.mod.crops.BlueCrop;
import net.morefood.mod.crops.PapCrop;
import net.morefood.mod.crops.StrawCrop;
import net.morefood.mod.crops.TomCrop;
import net.morefood.mod.crops.UniCrop;
import net.morefood.mod.food.Drink;
import net.morefood.mod.food.GrapeSpeed;
import net.morefood.mod.food.GrapeSpeed2;
import net.morefood.mod.food.Soup;
import net.morefood.mod.food.Speed;
import net.morefood.mod.food.Stew;
import net.morefood.mod.mobdrop.SheepDrops;
import net.morefood.mod.mobdrop.SquidDrops;
